...
make_random_edges = _GOLDEN.make_random_edges
reference_graclus_cluster = _GOLDEN.reference_graclus_cluster
_npu_or_skip = _GOLDEN.npu_or_skip
_run_reference_and_npu = _GOLDEN.run_reference_and_npu
